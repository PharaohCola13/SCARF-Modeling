...
##
		...
		self.deg_lo = tk.Label(master, text=u"\u00B0")
		self.deg_lo.grid(row=0, column=5, sticky='new', padx=(0,0))
		...
		self.min_lo = tk.Label(master, text="'")
		self.min_lo.grid(row=0, column=7, sticky='new', padx=(0,n))
		...
		self.sec_lo = tk.Label(master, text="''")
		self.sec_lo.grid(row=0, column=9, sticky='new', padx=(0,n))
...
##
		...
		self.deg_la = tk.Label(master, text=u"\u00B0")
		self.deg_la.grid(row=0, column=5, sticky='new', pady=30, padx=(0,n))
		...
		self.min_la = tk.Label(master, text="'")
		self.min_la.grid(row=0, column=7, sticky='new', pady=30, padx=(0,n))
		...
		self.sec_la = tk.Label(master, text="''")
		self.sec_la.grid(row=0, column=9, sticky='new', pady=30, padx=(0,n))
...
##
		...
		def design(self):
			...
			entry 	= [self.erp_entry,self.frac_tim_entry,self.frequency_entry,self.ground_cond_entry,
						...
						self.temp_high_entry, self.name_entry, self.long_dms_d,self.long_dms_m,self.long_dms_s, self.lat_dms_d,self.lat_dms_m,self.lat_dms_s]
